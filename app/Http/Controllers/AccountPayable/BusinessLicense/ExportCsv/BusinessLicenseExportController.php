...
use App\Http\Controllers\AccountPayable\BusinessLicense\ExportCsv\BusinessLicenseCsv;

class BusinessLicenseExportController extends Controller {
...
//------------------------------------------------------------------------------
  public function index(Request $req){
    ...
    switch($op){
      case 'csv'     : return BusinessLicenseCsv::getCsv($vData);
    }
  }
################################################################################
##########################   HELPER FUNCTION   #################################  
