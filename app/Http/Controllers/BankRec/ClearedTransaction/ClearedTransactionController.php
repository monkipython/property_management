<?php
namespace App\Http\Controllers\BankRec\ClearedTransaction;
 ...
 */
class ClearedTransactionController extends Controller {
...
//------------------------------------------------------------------------------
  private function _getColumnButtonReportList($req){
    ...
    $data   = [];
    $data[] = ['field'=>'cleared_trans_id','visible'=>false];
    $data[] = ['field'=>'num', 'title'=>'#', 'width'=> 25];
    $data[] = ['field'=>'checkbox', 'checkbox'=>true, 'width'=>25];
    
    $data[] = ['field'=>'date1','title'=>'Date','sortable'=>true,'filterControl'=>'input','width'=>120];
