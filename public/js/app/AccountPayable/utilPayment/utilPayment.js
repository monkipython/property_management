var app = {
  _url: '/utilPayment',
  _urlUpload: '/uploadUtilPayment',
  _urlStorePayment: '/utilPaymentStorePayment',
  _urlUploadPaymentStore: '/uploadUtilPayment',
...
//------------------------------------------------------------------------------
  edit: function(row){
    var id = row.id;
    CONFIRM({
      title: '<b class="text-red"><i class="fa fa-fw fa-money"></i> EDIT UTILITY PAYMENT</b>',
      content: function(){
        var self = this;
        AJAX({
...
//------------------------------------------------------------------------------
  create: function(){
    $('#new').on('click', function() {
      CONFIRM({
        title: '<b class="text-red"><i class="fa fa-fw fa-money"></i> CREATE UTILITY PAYMENT</b>',
        content: function(){
          var self = this;
          AJAX({
            url     : app._url + '/create',
...
//------------------------------------------------------------------------------
  delete: function(){
    ...
    $delete.on('click', function() {
      ...
      var sData = {'id': ids};
      CONFIRM({
        title: '<b class="text-red"><i class="fa fa-trash"></i> DELETE UTILITY PAYMENT</b>',
        content: ' Are you sure you want to delete ' + ids.length + ' utility payment(s).',
        buttons: {
          delete: {
        ...
        AJAX({
          ...
          success: function(responseData){
            ...
            UPLOAD(
              ...
              {op:'UtilPayment',type:'util_payment',foreign_id:licenseId,vendor_payment_id:$(html).attr('data-hidden-id')}
            );
            var formId = '#utilPaymentStoreForm';
            $(formId).unbind('submit').on('submit',function(){
              AJAXSUBMIT(formId, {
