@extends('template', ['jsCss'=>'/creditCheck/agreement'])
...
@section('content')
<div class="row">
<div class="container col-sm-12" id="agreementFormContainer"> 
    <form id="agreementForm" autocomplete="off">
      {!! $data['hiddenInputs'] !!}
      <h2 style="text-align:center;"><b>Tenant Rental Agreement</b></h2>
      <p>This Rental Agreement and/or Lease (agreement) shall evidence the complete terms and conditions under which the parties whose signatures appear below have agreed {!! $data['defaultValues']['management_name_'][0] !!}. Landlord, Landlord/Lessor/Agent shall be referred to as "LANDLORD" and and Tenants(s) Lessee(s) shall be referred to as "TENANT":
</p>
<table>
    <tr id="section_1">
        <td width="15"><p><b><u>&nbsp;1.</u></b></p></td>
        <td><p></p></td>
        <td></td>
    </tr>
</table>
      <table>
          ...
          <tr>
              <td width="15"></td>
              <td width="20">1.1</td>
              <td width="500"><p>In addition to Tenant, the following individuals will also reside at the Premises ("Occupants"):</td>
          </tr>
        ...
        {!! $data['occupantForm'] !!}
          <tr>
              <td width="15"></td>
              <td width="20">1.2.</td>
              <td width="500"><p>Tenant represents, warrants and covenants that all persons who will reside at the Premises as Occupants are listed in Section 1.2, above. All Occupants over the age of 18 are required to be listed in Section 1.1 as Tenant and are subject to any and all application approval requirements.</p></td>
          </tr>
          <tr>
              <td></td>
              <td>1.3.</td>
              <td><p>As consideration for this Agreement, LANDLORD agrees to rent/lease to TENANT and TENANT agree to rent/lease from LANDLORD for use SOLEY AS A PRIVATE RESIDENCE, the premises known as Section 2.</p></td>
          </tr>
          <tr><td></td><td></td><td></td></tr>
      </table>
      <table>
          <tr id="section_2">
                <td style="white-space: nowrap;"><p><b><u>&nbsp;2. UTILITIES</u></b></p></td>
            </tr>
      </table>
      <table>  
          <tr>
              <td width="15"></td>
              <td width="20">2.1.</td>
              <td width="500"><p>LANDLORD rents to TENANT and TENANT rents from LANDLORD, the real property and improvements<br /><br />described as Property No. {!! $data['defaultValues']['prop_no_'][0] !!} Unit No.{!! $data['defaultValues']['unit_no_'][0] !!}, located at ("Premises")<br>{!! $data['defaultValues']['premises_'][0] !!}.<br>(Address, City, State, Zip)</p></td>
          </tr>
          <tr>
              <td></td>
              <td>2.2.</td>
              <td><p>The Premises are for the sole use as a private residence by the above named Tenant(s) and Occupant(s), for a total of {!! $data['defaultValues']['num_occupants_'][0] !!} occupants, and by no other persons without prior written consent of the Landlord.</p></td>
          </tr>
          <tr>
              <td></td>
              <td>2.3.</td>
              <td><p>The following personal property is included: {!! $data['defaultValues']['included_properties_'][0] !!}</p></td>
          </tr>
      </table>
      <table>
          <tr id="section_3">
              
              <td style="white-space: nowrap;"><p><b><u>&nbsp;3. RENTAL TERM</u></b></p></td>
          </tr>
      </table>
        <table>
            <tr>
              <td width="15"></td>
              <td width="20">3.1</td>
              <td width="500"><p>The Rental Term begins on {!! $data['defaultValues']['rental_begin_date_'][0] !!} ("Commencement Date"), and shall continue as a month to month tenancy until either party shall terminate this agreement; such month to month period being referred to as the "Rental Term."</p></td>
            </tr>
            <tr>
                <td width="15"></td>
                <td width="20">3.2.</td>
                <td width="500"><p>Notwithstanding anything to the contrary set forth in Section 3.1, Tenant and all Occupants must vacate the Premises upon the Termination or such earlier date this Agreement is terminated pursuant to the terms hereof. Either party may terminate by giving the other 30-days written notice of termination in writing pursuant to California <u>Civil Code</u> 1946; however, if the Tenant has resided in the unit for one year or more, than the Landlord must give at least 60-days written notice to terminate tenancy (CC'1946). In addition, Landlord may terminate the tenancy and this Agreement by giving written notice as provided by law.</p></td>
            </tr>
        </table>
        <table>
            <tr id="section_4">
                
                <td style="white-space: nowrap;"><p><b><u>&nbsp;4. RENT / PAYMENTS</u></b></p></td>
            </tr>
        </table>
        <table>
            <tr>
                <td width="15"></td>
                <td width="20">4.1.</td>
                <td width="500"><p>"Rent" will mean all monetary obligations of Tenant to Landlord under the terms of this Agreement.</p></td>
            </tr>
            <tr>
                <td></td>
                <td>4.2.</td>
                <td><p>Tenant agrees to pay {!! $data['defaultValues']['monthly_rent_'][0] !!} per month during the Rental Term. Landlord will have the right to increase Rent as permitted by applicable law. All payments made are non-refundable. No refunds will be issued. </p></td>
            </tr>
            <tr>
                <td></td>
                <td>4.3.</td>
                <td><p>If Commencement Date falls on any day other than the day Rent is payable under paragraph 4.5., and Tenant has Paid One full month’s Rent in Advance of Commencement Date, Rent for the second calendar month shall be prorated and Tenant shall pay 1/30<sup>th</sup> of the monthly rent per day for each day remaining in the prorated second month.</p></td>
            </tr>
            <tr>
                <td></td>
                <td>4.4.</td>
            ...
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td width="15"></td>
                            <td width="20"><p>4.6.1.</p></td>
                            <td width="500"><p>For the safety of the manager, all payments are to be made by Cashier’s Check or Money Order.</p></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td width="15"></td>
                            <td width="20"><p>4.6.2.</p></td>
                            <td width="500"><p>&nbsp;No Cash or Personal Checks shall be accepted.</p></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td width="15"></td>
                            <td width="20"><p>4.6.3.</p></td>
                            <td width="500"><p>Submit money order or cashier’s check at the office or apartment of the manager of the building or at such other place designated in writing by Landlord.</p></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr id="section_4_7">
                <td></td>
                <td>4.7.</td>
                <td><p><label class="control-label">All payments make payable to:</label>{!! $data['defaultValues']['payments_to_'][0] !!}.</p>
                    <p>(<u>Property Management Co. "LANDLORD"</u>, <u>Property No.</u>, <u>Unit No.</u>) (phone number is) {!! $data['defaultValues']['payment_phone_number_'][0] !!} <br /> <label class="control-label">at (address)</label>{!! $data['defaultValues']['rent_payment_address_'][0] !!}</p>
                    <p>Rent may be paid personally, between the hours of: <b><u>9:00 AM</u></b> to <b><u>6:00 PM</u></b> on <b><u>Monday to Friday.</u></b><b><u>10:00 AM</u></b> to <b><u>5:00 PM</u></b> on <b><u>Saturday</u></b> and <b><u>Sunday</u></b></p>
                    <p><b>Additional Information</b>{!! $data['defaultValues']['property_additonal_info_'][0] !!}</p>
                    <p><b>Tenant's Initial(s)&nbsp;&nbsp;&nbsp;</b>{!! $data['defaultValues']['tnt_initial_'][0] !!}</p>
                </td>
            </tr>
            <tr>
                <td></td>
        ...
        <table>
            <tr id="section_5">
                <td style="white-space: nowrap;"><b><u>&nbsp;5. SECURITY DEPOSIT</u></b></td>
            </tr>
        </table>
        <table>
            <tr>
                <td width="15"></td>
                <td width="20">5.1.</td>
                <td width="500"><p>Tenant must pay to Landlord on or before the Commencement Date {!! $data['defaultValues']['sec_dep_'][0] !!} as a security deposit (the "Security Deposit"), which amount will be maintained throughout tenancy.</p></td>
            </tr>
            <tr>
                <td></td>
                <td>5.2.</td>
            ...
            <tr>
                <td></td>
                <td>5.4.</td>
                <td><p>The Security Deposit will not be returned until the Premises has been vacated by Tenant and all other Occupants, if any, and all keys have been returned to Landlord. Any Security Deposit returned by check will be made out to each Tenant named on this Agreement, and mailed to the address provided by Tenant to Landlord.</p></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                <td>
                  <p><label class="control-label">5.4.1.  Security Deposit return mailing address (Optional)</label>: {!! $data['defaultValues']['sec_dep_return_address_'][0] !!}.</p>
                </td>
            </tr>
            <tr>
                <td style="white-space: nowrap;" width="500"><p><b>Tenant's Initial(s)&nbsp;&nbsp;&nbsp;</b>{!! $data['defaultValues']['tnt_initial_'][1] !!}</p>
            </tr>
        </table>
        <table>
            <tr>
                <td width="15"></td>
                <td width="20">5.5.</td>
                <td width="500"><p>No interest will be paid on the Security Deposit unless required by law.</p></td>
            </tr>
            <tr>
                <td></td>
                <td>5.6.</td>
        ...
        <table>
            <tr id="section_6">
                ...
                <td style="white-space: nowrap;"><p><b><u>&nbsp;6. UTILITIES</u></b></p></td>
            </tr>
        </table>
        <table>
          <tr>
            <td width="15"></td>
            <td width="20">6.1.</td>
            <td width="500"><p>Tenant agrees to pay for all utilities and services serving the Premises. If any utilities are not separately metered, Tenant must pay Tenant's proportional share, as reasonably determined and directed by Landlord. If utilities are separately metered, Tenant must place utilities in Tenant's name on or before <b>Commencement Date</b>. Tenant must pay any cost for conversion from existing utilities service providers. Landlord is only responsible for installing and maintaining one usable telephone jack in the Premises.</p></td>
          </tr>
          <tr>
              <td></td>
              <td>6.2.</td>
              <td>
                  <p>Selected below services Tenant agrees to pay directly to service provider:<br>
                    <b>Electricity ({!! $data['defaultValues']['electricity_service_'][0] !!}), Gas ({!! $data['defaultValues']['gas_service_'][0] !!}), Water / Sewer ({!! $data['defaultValues']['water_service_'][0] !!}), Trash ({!! $data['defaultValues']['garbage_service_'][0] !!}), Other {!! $data['defaultValues']['other_service_'][0] !!}</b><br>
                    Or reimburse Landlord:<br>
                    <b>Electricity ({!! $data['defaultValues']['electricity_reimburse_'][0] !!}), Gas ({!! $data['defaultValues']['gas_reimburse_'][0] !!}), Water / Sewer ({!! $data['defaultValues']['water_reimburse_'][0] !!}), Trash ({!! $data['defaultValues']['garbage_reimburse_'][0] !!}), Other {!! $data['defaultValues']['other_reimburse_'][0] !!}</b>
                  </p>
              </td>
          </tr>
          <tr>
          ...
          <tr>
              <td width="15"></td>
              <td width="20">8.1.</td>
              <td width="500"><p>Tenant must store only personal property Tenant owns, and must not store property claimed by another or in which another has any right, title or interest. Tenant must not store any flammable materials, explosives, hazardous waste or other inherently dangerous material, or illegal substances.</p></td>
            </tr>
            <tr>
              <td></td>
              <td>8.2.</td>
              <td><p>The right to separate storage space <b>({!! $data['defaultValues']['provide_storage_'][0][0] !!}) is, ({!! $data['defaultValues']['provide_storage_'][0][1] !!}) is <u>not</u> included</b> in the Rent charged pursuant to paragraph 4. <span id="storage_cost_[0]" class="hide-on-load">If not included in Rent, storage space fee shall be an additional {!! $data['defaultValues']['storage_cost_'][0] !!} per month.</span></p></td>
            </tr>
          <tr id="section_9">
            <td style="white-space: nowrap;"><p><b><u>&nbsp;9. PETS</u></b></p></td>
          </tr>
        </table>
        <table>
            <tr>
              <td width="15"></td>
              <td width="20">9.1.</td>
              <td width="500"><p>Unless otherwise provided in California <u>Civil Code</u> 54.2, or other law, no animal or pet must be kept on or about the Premises without Landlord's prior written consent. Landlord hereby consents to the following pets being kept at the Premises: <b>Yes</b> {!! $data['defaultValues']['provide_pets_'][0][0] !!} , <b>No</b> {!! $data['defaultValues']['provide_pets_'][0][1] !!}<br /><span id="pets_cost_[1]" class="hide-on-load">{!! $data['defaultValues']['included_pets_'][0] !!}</span></p></td>
            </tr>
            <tr>
              <td></td>
              <td>9.2.</td>
            ...
            <tr id="section_10">
             <td style="white-space: nowrap;"><p><b><u>&nbsp;10. MOVE-IN COSTS</u></b></p></td>
            </tr>
        </table>
        <table id="move_in_costs_table">
            <tr>
                <td width="15"></td>
                <td width="20"></td>
                <td width="500">{!! $data['prorate'] !!}</td>
            <tr>
                <td width="15"></td>
                <td width="20">10.1.</td>
                <td width="500"><p>The following move-in funds must be paid to Landlord by Cashier’s Check or Money Order, upon Rental Agreement execution:</p></td>
            </tr>
            <tr>
                <td></td>
                <td>10.2.</td>
                <td><p>Security Deposit<span class="cost">{!! $data['defaultValues']['sec_dep_'][1] !!}</span></p></td>
            </tr>
            <tr>
                <td></td>
                <td>10.3.</td>
                <td><p>First Month’s Rent<span class="cost">{!! $data['defaultValues']['monthly_rent_'][1] !!}</span></p></td>
            </tr>
            <tr id="next_month_entry">
                <td></td>
                <td></td>
                <td style="visibility:none;"><p>Next Month's Rent<span class="cost">{!! $data['defaultValues']['next_month_rent_'][0] !!}</span></p></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                <td><p class="hide-on-load" id="parking_cost_[1]">Parking Cost<span class="cost">{!! $data['defaultValues']['parking_cost_'][1] !!}</span></p></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                <td><p class="hide-on-load" id="storage_cost_[1]">Storage Cost<span class="cost">{!! $data['defaultValues']['storage_cost_'][1] !!}</span></p></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
                <td><p class="hide-on-load" id="pets_cost_[0]">Pet Cost<span class="cost">{!! $data['defaultValues']['pets_cost_'][0] !!}</span></p></td>
            </tr>
            <tr>
                <td></td>
                <td width="200"><b>TOTAL DUE UPON LEASE EXECUTION</b></td>
                <td><p><span class="cost">{!! $data['defaultValues']['total_cost_'][0] !!}</span></p></td>
            </tr>
<!--            <tr>
                <td></td>
                <td>10.4.</td>
                <td><p>Next Month’s Rent (if applicable)<span class="cost">{!! $data['defaultValues']['next_month_rent_'][0] !!}</span></p></td>
            </tr>-->
            <tr>
              <td style="white-space: nowrap;"><p><b>Tenant's Initial(s)&nbsp;&nbsp;&nbsp;</b>{!! $data['defaultValues']['tnt_initial_'][2] !!}</p>
            </tr>
            <tr>
             <td width="15"><p><b></b></p></td>
             <td width="200"><p><b><u>LATE FEE; RETURNED CHECK FEE</u></b></p></td>
            </tr>
        </table>
      <table>
        <tr>
      ...
      <table>
        ...
        <tr>
            <td></td>
            <td></td>
            <td style="width:100%;padding-left: 0;"><p class="left-padding-p">If any legal action or proceeding is brought by either party to enforce any part of this Agreement, the prevailing party shall recover, in addition to all other relief, actual attorney’s fees and cost pursuant to California <u>Civil Code</u> 1717, but not to exceed $750.00. Recognizing that a Jury Trial is both time consuming and expensive, <u>LANDLORD AND TENANT HEREBY WAIVE TRIAL BY JURY IN ANY
ACTION, PROCEEDING OR COUNTERCLAIM BROUGHT BY EITHER OF THE PARTY HERETO AGAINST THE OTHER IN RESPECT OF ANY
MATTER ARISING OUT OF OR IN CONNECTION WITH THIS AGREEMENT OR THE USE, OR THE OCCUPANCY OF THE PREMISES HEREIN..</u></p>
            <p><b>Landlord: </b>{!! $data['defaultValues']['landlord_signature_'][0] !!}</p>
            <p>{!! $data['defaultValues']['tnt_signature_'][0] !!}</p>
            </td>
        </tr>
        <tr id="section_12">
      ...
      <table>
        <tr>
            <td width="15"></td>
            <td width="20"></td>
            <td width="500" style="width:100%;"><p class="left-padding-p">As required by law, you are hereby notified that negative credit reports reflecting on your credit record may be submitted to a credit reporting agency and/or your credit may be checked periodically.</p></td>
        </tr>
        <tr id="section_13">  
            <td style="white-space: nowrap;"><p><b><u>&nbsp;13. CONDITION OF PREMISES</u></b></p></td>
        </tr>
            <tr>
                <td></td>
                <td></td>
                <td width="500" style="padding-left:0;">
                    <p class="left-padding-p">Tenant has examined the Premises,<u>including smoke/carbon monoxide detector(s)</u> and, if any, all furniture, furnishings, appliances, landscaping and fixtures, and Tenant acknowledges these items are clean and in operable condition. With the following exceptions, if any are so specified: <a href="#section_55_6"><b><u>see MIMO Inspection Checklist.</u></b></a></p>
                </td>
            </tr>
            <tr id="section_14">
              
              <td style="white-space:nowrap;"><p><b><u>&nbsp;14. CARBON MONOXIDE DETECTOR NOTICE</u></b></p></td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <tr id="section_15">
              ...
              <td style="white-space:nowrap;"><p><b><u>&nbsp;15. MAINTENANCE</u></b></p></td>
            </tr>
          </table>
          <table>  
            <tr>
          ...
          <table>
            ...
            <tr>
              <td></td>
              <td>19.3.</td>
              <td><p>Tenant has been provided with, and acknowledges receipt of, a copy of the rules and regulations. See attached: <b><a href="#section_55_5">Addendum to Rental Agreement Apartment / House Rules.</a></b></p></td>
            </tr>
            <tr>
                <td style="white-space: nowrap;" width="500"><p><b>Tenant's Initial(s)&nbsp;&nbsp;&nbsp;</b>{!! $data['defaultValues']['tnt_initial_'][4] !!}</p>
            </tr>
            <tr id="section_20">
              
              <td style="white-space: nowrap;"><p><b><u>&nbsp;20. CONDOMINIUM; PLANNED UNIT DEVELOPMENT (If Applicable)</u></b></p></td>
            </tr>
          </table>
          <table>
            <tr>
              <td width="15"></td>
              <td width="20">20.1.</td>
              <td width="500"><p>The Premises are a unit in a condominium, planned unit development, common interest subdivision or other development governed by a homeowners’ association ("HOA"). The name of the HOA is {!! $data['defaultValues']['hoa_name_'][0] !!}. Tenant agrees to comply with all HOA covenants, conditions and restrictions, by laws, rules and regulations and decisions ("HOA Rules"). Tenant shall reimburse Landlord for any fines or charges imposed by HOA or other authorities, due to any violation by Tenant, or the guests or licensees of Tenant or Landlord shall have the right to deduct such amounts from the security deposit, Section 5.1.</p></td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td><p>If applicable, Tenant is required to pay a fee to the HOA to gain access to certain areas within the development such as but not necessarily including or limited to the front gate, pool, and recreational facilities. If not specified in Section 6, Tenant is solely responsible for payment and satisfying an HOA requirements prior to or upon or after the Commencement Date.</p></td>
            </tr>
            <tr>
              <td></td>
              <td>20.2.</td>
              <td><p>Landlord shall provide Tenant with a copy of the HOA Rules within {!! $data['defaultValues']['hoa_days_'][0] !!} Days.</p></td>
            </tr>
            <tr>
                <td colspan="3" width="500"><p><b>Tenant's Initial(s)&nbsp;</b>{!! $data['defaultValues']['tnt_initial_'][5] !!}<br />Tenant has been provided with, and acknowledges receipt of a copy of the HOA Rules.</p></td>
            </tr>
            <tr id="section_21">
              
              <td style="white-space: nowrap;"><p><b><u>&nbsp;21. ALTERATIONS; REPAIRS</u></b></p></td>
            </tr>
            <tr>
              <td colspan="3" width="500">
                  <p class="left-padding-p">Unless otherwise specified by law or in this Agreement, without Landlord's prior written consent, <b>(i)</b> Tenant must not make any alterations or improvements or material repairs in or about the Premises including: painting, wallpapering, adding or changing locks, installing antenna or satellite dish(es), placing signs, displays or exhibits, or using screws, fastening devices, large nails or adhesive materials; <b>(ii)</b> Landlord will not be responsible for the costs of alterations or repairs made by Tenant; <b>(iii)</b> Tenant must not deduct from Rent the costs of any repairs, alterations or improvements; and <b>(iv)</b> any deduction made by Tenant will be considered unpaid Rent.</p>
              </td>
            </tr>
            <tr id="section_22">
              
              <td style="white-space: nowrap;"><p><b><u>&nbsp;22. KEYS AND LOCKS</u></b></p></td>
            </tr>
          </table>
          <table>
            <tr>
              <td width="15"></td>
              <td width="20">22.1.</td>
              <td width="500"><p>Tenant acknowledges receipt of {!! $data['defaultValues']['premise_keys_'][0] !!} Key(s) to Premises.</p></td>
            </tr>
            <tr>
                <td></td>
                <td>22.2</td>
                <td><p>Tenant acknowledges receipt of {!! $data['defaultValues']['mailbox_keys_'][0] !!} Key(s) to mailbox.</p></td>
            </tr>
            <tr>
              <td></td>
              <td>22.3.</td>
            ...
            <tr id="section_23">
              ...
              <td style="white-space: nowrap;"><p><b><u>&nbsp;23. RIGHT OF ENTRY</u></b></p></td>
            </tr>
          </table>
          <table>
            <tr>
          ...
          <table>
            <tr>
              <td width="15"></td>
              <td width="20">33.1.</td>
              <td width="500"><p>Upon termination of this Agreement, Tenant must: (i) give Landlord all copies of all the keys or opening devices to the Premises, including any common areas; (ii) vacate and surrender the Premises to Landlord, empty of all persons; and personal property belonging to Tenant (iii) vacate any/all parking and/or storage space; (iv) clean and deliver the Premises, as specified below, to Landlord in the same condition as received by Tenant and described in this Agreement; (v) remove all debris; and (vi) give written notice to Landlord of Tenant's forwarding address.</p></td>
            </tr>
            <tr>
              <td></td>
              <td>33.2.</td>
            ...
            <tr id="section_34">
              ...
              <td style="white-space: nowrap;"><p><b><u>&nbsp;34. DEFAULT</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">Tenant will be in default under this Agreement if Tenant: (i) fails to pay Rent when due, or (ii) fails to perform any other obligation or duty of Tenant under this Agreement, which failure to pay or perform continues for three (3) days after the delivery of written notice to Tenant of such default in the manner required by law (an "Event of Default"). Any notice required to be given for Tenant to be in default hereunder will not be deemed to be in addition to any statutorily required notice as long as the notice given hereunder otherwise complies with the terms of the applicable statute.</p>
                </td>
            </tr>
            <tr id="section_35">
              
              <td style="white-space: nowrap;"><p><b><u>&nbsp;35. REMEDIES</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">After the occurrence of an event of Default, in addition to any and all other remedies available to Landlord at law or in equity, Landlord will have the right to the following:</p>
                </td>
            </tr>
          </table>
          <table>
            ...
            <tr id="section_36">
              ...
              <td style="white-space: nowrap;"><p><b><u>&nbsp;36. DAMAGE TO PREMISES</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">If, by no fault of Tenant, the Premises are totally or partially damaged or destroyed by fire, earthquake, accident or other casualty that render the Premises totally or partially uninhabitable, either Landlord or Tenant may terminate this Agreement by giving the other written notice. Rent will be abated as of the date the Premises become totally or partially uninhabitable. The abated amount will be the current monthly Rent prorated on a 30-day period. If this Agreement is not terminated, Landlord will promptly repair the damage, and Rent will be reduced based on the extent to which the damage interferes with Tenant's reasonable use of the Premises. If damage occurs as a result of an act of Tenant or Tenant's guests, only Landlord will have the right of termination, and no reduction or abatement of Rent will be made.</p>
                </td>
            </tr>
            <tr id="section_37">
              
              <td style="white-space: nowrap;"><p><b><u>&nbsp;37. INSURANCE</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">Tenant's and Tenant's guest's personal property and vehicles are not insured by Landlord, the property manager, if any, or, if applicable, HOA, against loss or damage due to fire, theft, vandalism, rain, water, criminal or negligent acts of others, or any other cause. <b>Tenant is advised to carry Tenant's own insurance (so-called "renter's insurance") to protect Tenant from any such loss or damage.</b> Tenant must comply with any requirement imposed on Tenant by Landlord's insurer to avoid: (i) an increase in Landlord's insurance premium (or Tenant must pay for the increase in premium); or (ii) loss of insurance.</p>
                </td>
            </tr>
            <tr>
              <td style="white-space: nowrap;" width="500"><p><b>Tenant's Initial(s)&nbsp;&nbsp;&nbsp;</b>{!! $data['defaultValues']['tnt_initial_'][8] !!}</p></td>
            </tr>
            <tr id="section_38">
              
              <td style="white-space: nowrap;"><p><b><u>&nbsp;38. WATERBEDS; AQUARIUMS; WASHING MACHINE</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">Any waterbeds, or liquid-filled furniture as provided under California <u>Civil Code</u> 1940.5, are not permitted. Aquariums larger than 10 gallons are not permitted. Tenant may not have washing machine in unit if not properly plumbed for such.</p>
                </td>
            </tr>
            <tr id="section_39">
             
              <td style="white-space: nowrap;"><p><b><u>&nbsp;39. WAIVER</u></b></p></td>
            </tr>
          </table>
          <table>
            <tr>
            ...
            <tr id="section_40">
              ...
              <td style="white-space: nowrap;"><p><b><u>&nbsp;40. TENANT ESTOPPEL CERTIFICATE</u></b></p></td>
            </tr>
          </table>
          <table>
            <tr>
          ...
          <table>
            ...
            <tr id="section_42">
              ...
              <td style="white-space: nowrap;"><p><b><u>&nbsp;42. MEDIATION</u></b></p></td>
            </tr>
          </table>
          <table>
            <tr>
            ...
            <tr id="section_43">
              ...
              <td style="white-space: nowrap;"><p><b><u>&nbsp;43. TIME OF ESSENCE; ENTIRE CONTRACT; CHANGES, ETC</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">Time is of the essence. All understandings between the Parties are incorporated in this Agreement. Its terms are intended by the Parties as a final, complete and exclusive expression of their agreement with respect to its subject matter, and may not be contradicted by evidence of any prior agreement or contemporaneous oral agreement. If any provision of this Agreement is held to be ineffective or invalid, the remaining provisions will nevertheless be given full force and effect. Neither this Agreement nor any provision in it may be extended, amended, modified, altered or changed except in writing. This Agreement is subject to California law and will incorporate all changes required by amendment or successors to such law. This Agreement and any supplement, addendum or modification, including any copy, may be signed in two or more counterparts, all of which will constitute one and the same agreement. This Agreement is the joint drafting effort of both parties.
Every covenant, term, and provision of this Agreement shall be construed simply according to its fair meaning and not strictly for or against any
party (notwithstanding any rule of law requiring an Agreement to be strictly construed against the drafting party). Captions contained in this
Agreement in no way define, limit or extend the scope or intent of this Agreement.</p>
                </td>
            </tr>
            <tr id="section_44">
               
              <td style="white-space: nowrap;"><p><b><u>&nbsp;44. MILITARY SERVICE TERMINATION RIGHT</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">In the event that Tenant, is or hereafter becomes, a member of the United States Armed Forces on extended active duty and receives permanent change of station orders to depart from the area where the Premises are located (which for purposes of this Section means an area in excess of fifty (50) miles from the Premises), or is ordered into military housing, then in any of these events, Tenant may terminate this Agreement upon giving not less than thirty (30) days written notice to Landlord. Tenant must also provide to Landlord a copy of the official orders or a letter signed by Tenant's commanding officer, reflecting the change, which entitles Tenant to the right to terminate this Agreement early under this Section. Security Deposit will be disposed per terms of Section 5 of this Agreement.</p>
                </td>
            </tr>
            <tr id="section_45">
               
              <td style="white-space: nowrap;"><p><b><u>&nbsp;45. SUBORDINATION OF AGREEMENT; ATTORNMENT OF TENANT</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">This Agreement and Tenant’s interest hereunder are and shall be subordinate, junior and inferior to any and all mortgages, deeds of trust, deeds to secure debt, and similar instruments (collectively, "Mortgage Documents"), now or hereafter placed on the Premises, all advances made under any Mortgage Documents (including, but not limited to, future advances), the interest payable on any Mortgage Documents and any and all renewals, extensions or modifications of any Mortgage Documents. Tenant also hereby agrees to attorn, without any deductions or set-offs whatsoever, to any holder of any Mortgage Documents and any other purchaser at a sale of the Premises by foreclosure or power of sale, or any deed in lieu of any of the foregoing, and recognize such holder or other purchaser, as the case may be, as the Landlord under the Agreement. If requested by Landlord, Tenant agrees to execute and deliver any document requested by Landlord in order to further evidence the subordination and attornment described in this Section.</p>
                </td>
            </tr>
            <tr id="section_46">
                
                <td style="white-space: nowrap;"><p><b><u>&nbsp;46. Class Action Waiver</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                    <p class="left-padding-p">Tenant hereby waives and relinquishes the right to consolidate any claims it may have against any of the Landlord Parties arising out of,
related to or in connection with this Agreement or the use or occupancy of the Premises with the claims of any other person or entity in
any litigation, arbitration or other proceeding, and Tenant hereby agrees not to participate in any class or consolidated action or any form
of a class or representative proceeding against Landlord Parties.</p>
                </td>
            </tr>
            <tr id="section_47">
               
              <td style="white-space: nowrap;"><p><b><u>&nbsp;47. ASSIGNMENT BY LANDLORD</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">Landlord shall have the right to, either voluntarily, involuntarily, by operation of law or otherwise, sell, assign, transfer or hypothecate the Agreement.</p>
                </td>
            </tr>
            <tr id="section_48">
               
              <td style="white-space: nowrap;"><p><b><u>&nbsp;48. SUCCESSORS AND ASSIGNS</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">All of the covenants, conditions and provisions of the Agreement shall inure to the benefit of Landlord and its respective heirs, personal representatives, successors and assigns.</p>
                </td>
            </tr>
            <tr id="section_49">
               
              <td style="white-space: nowrap;"><p><b><u>&nbsp;49. LANDLORD LIABILITY</u></b></p></td>
            </tr>
          </table>
          <table>
            <tr>
              <td width="15"></td>
              <td width="20">49.1.</td>
              <td width="500"><p>Landlord shall not be liable or responsible in any way for injury to any person, or for loss of, or damage to, any article belonging to Tenant located in said premises, or other premises under control of Landlord. No right of storage is given by this Agreement. Landlord shall not be liable for non-delivery or mis-delivery of messages nor shall landlord be liable for and this Agreement shall not be terminated by reason of any interruption of, or interference with, services or accommodation due Tenant, caused by strike, riot, orders of public authorities, acts of other tenants, accident, the making of necessary repairs to the building of which said premises are a part, or any other cause beyond Landlord’s control.</p></td>
            </tr>
            <tr>
              <td></td>
              <td>49.2.</td>
              <td><p>Notwithstanding anything else that may be construed to the contrary herein (including the Addenda), Landlord’s liability, together with the
liability of the Landlord Related Parties, under this Agreement, as well as the use and occupancy of the Premises shall be capped at an
amount equal to four (4) times the monthly rental rate payable by the Tenant each month up to a maximum aggregate amount of $10,000.
Tenant acknowledges that Landlord has set the monthly rental rate for the unit based on the liability cap in the immediately preceding
sentence, and that Landlord is relying on such liability cap in entering into this Agreement. Landlord's liability under this Agreement will be limited to Landlord's unencumbered interest in the Premises. Neither Landlord nor any of its partners, members, officers, directors, agents, employees, shareholders, successors, assigns or pledges, including without limitation, the individual signing this Agreement on Landlord's behalf, will in any way be personally liable under this Agreement, and Tenant hereby waives the right to claim any such
personal liability.</p></td>
            </tr>
            <tr id="section_50">
               
              <td style="white-space: nowrap;"><p><b><u>&nbsp;50. SATELLITE DISHES</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">Tenant may install one satellite dish on the Premises, provided it does not exceed one (1) meter (3.3 feet) in diameter. Tenant's installation must comply with reasonable safety standards and may not interfere with any cable, telephone or electrical systems within or serving the Premises. Installation must be done by a qualified person or company and the satellite dish cannot be installed or affixed to the roof of the Premises. Tenant will have the sole responsibility for maintaining any satellite dish or antenna and all related equipment. Tenant must pay for any damages and for the cost of repairs or repainting which may be reasonably necessary to restore the Premises to its condition prior to the installation of any satellite dish or related equipment. Tenant agrees to hold Landlord harmless, defend and indemnify Landlord against any claims or injuries related to Tenant's installation of a satellite dish. If Tenant installs a satellite dish or antenna prior to satisfying the conditions set forth above, then Tenant shall be deemed in default under the Agreement.</p>
                </td>
            </tr>
            <tr id="section_51">
               
              <td style="white-space: nowrap;"><p><b><u>&nbsp;51. NO ENCUMBRANCES PERMITTED</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">Tenant has no authority or power to cause or permit any lien or encumbrance of any kind whatsoever, whether created by act of Tenant, operation of law or otherwise, to attach to or be placed upon the Premises. Landlord will have the right at all times to post and keep posted on the Premises any notice which it deems necessary for protection from such liens. Tenant covenants and agrees not to suffer or permit any lien of mechanics or materialmen or others to be placed against the Premises with respect to work or services claimed to have been performed for or materials claimed to have been furnished to Tenant or the Premises, and, in case of any such lien attaching or notice of any lien, Tenant covenants and agrees to cause it to be immediately released and removed of record. Notwithstanding anything to the contrary set forth in this Agreement, if any such lien is not released and removed on or before the date notice of such lien is delivered by Landlord to Tenant, Tenant will be deemed in default hereunder and Landlord, at its sole option, may immediately take all action necessary to release and remove such lien, without any duty to investigate the validity thereof, and all sums, costs and expenses, including reasonable attorneys' fees and costs, incurred by Landlord in connection with such lien will be deemed Rent under this Agreement and will immediately be due and payable by Tenant.</p>
                </td>
            </tr>
            <tr id="section_52">
               
              <td style="white-space: nowrap;"><p><b><u>&nbsp;52. INDEPENDENT AGENT AND COUNSEL</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                  <p class="left-padding-p">Tenant agrees and acknowledges that the listing agent and leasing agent exclusively represent Landlord. Tenant is advised to consult its own real estate agent and/or counsel in connection with this Agreement.</p>
                </td>
            </tr>
            <tr id="section_53">
                
                <td style="white-space: nowrap;"><p><b><u>&nbsp;53. ADVERTISING TO LEASE OR SUBLEASE OF PREMISES.</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                    <p class="left-padding-p">It shall be considered a non-curable breach of this Rental Agreement if Tenant or any Occupant, directly or indirectly, (i) advertise in any print or electronic media to lease the Premises or (ii) sublease the Premises for any length of time. By way of example, advertising in AIRBNB would be considered a non-curable breech of this Rental Agreement.</p> 
                </td>
            </tr>
            <tr id="section_54">
                
                <td style="white-space: nowrap;"><p><b><u>&nbsp;54. HAZARD NOTICE:</u></b></p></td>
            </tr>
            <tr>
                <td colspan="3" width="500">
                    <p class="left-padding-p">Pursuant to Government Code Section 8589.45, Tenant may obtain information about hazards, including flood hazards, that may affect the property from the Internet Web site of the Office of Emergency Services athttp://myhazards.caloes.ca.gov/. The Landlord’s insurance does not cover the loss of the Tenant’s personal possessions and it is recommended that the Tenant consider purchasing renter’s insurance and flood insurance to insure his or her possessions from loss due to fire, flood, or other risk of loss. The Landlord is not required to provide additional information concerning the flood hazards to the property and the information provided pursuant to this section is deemed adequate to inform the Resident.
(Check box if applicable) {!! $data['defaultValues']['has_hazard_'][0] !!}  The Premises is located in a special flood hazard area or an area of potential flooding. 
</p> 
                </td>
            </tr>
            <tr id="section_55">
                <td  width="30" style="white-space: nowrap;"><p><b><u>55. ADDENDA: </u></b></p></td>
            </tr>
          </table>
          <table>
            <tr>
                <td colspan="3" width="500"><p class="left-padding-p"><b><u></u></b>The following Addenda and exhibits attached and referred to in this Agreement are hereby incorporated herein as fully set
forth in (and shall be deemed to be a part of) this Agreement.</p></td>
            </tr>
          </table>
          <table>
            <tr>
              <td width="15"></td>
              <td width="20">55.1.</td>
              <td width="500"><p>Complaint Procedure Addendum</p></td>
            </tr>
            <tr>
              <td></td>
              <td>55.2.</td>
...
<!--            <tr>
              <td></td>
              <td>55.15. </td>
              <td><p> Other: {!! $data['defaultValues']['other_addenda_'][0] !!}</p></td>
            </tr>-->
        </table>
        ...
        <p><b>Tenant:</b></p>
        <p>&nbsp;{!! $data['defaultValues']['tnt_signature_'][1] !!}</p>
        <p>{!! $data['defaultValues']['tenant_print_'][0] !!}</p>
        <p>{!! $data['defaultValues']['tenant_phone_'][0] !!}</p>
        <p>{!! $data['defaultValues']['tenant_email_'][0] !!}</p>
        <p><b>LANDLORD AGREES TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
        <p><b>Landlord: {!! $data['defaultValues']['landlord_signature_'][1] !!}</b></p>
        <p><b>By:</b></p>
        <p>{!! $data['defaultValues']['agent_signature_'][0] !!}</p>
        <h4 id="section_55_1"><b>55.1. Complaint Procedure Addendum</b></h4>
        ...
        <p>{!! $data['defaultValues']['notice_address_'][0] !!}</p>
        <p>(Phone number is) {!! $data['defaultValues']['payment_phone_number_'][1] !!} at (address)<br />{!! $data['defaultValues']['rent_payment_address_'][1] !!}</p>
        ...
        <p>If there is no onsite manager, such written notice must instead be given to the local office of <br />{!! $data['defaultValues']['notice_local_address_'][0] !!} <br /> where tenant pays its rent, as well as to the corporate office.</p>
        <p><b>Additional Notification Address: (Optional)</b></p>
        <p>{!! $data['defaultValues']['optional_address_'][0] !!}</p>
        <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
        <p>&nbsp;{!! $data['defaultValues']['tnt_signature_'][2] !!}{!! $data['defaultValues']['tenant_print_'][1] !!}</p>
        <h4 id="section_55_2"><b>55.2. Service Procedure Addendum</b></h4>
        <p><u>Service Procedure.</u> Tenant hereby acknowledges and agrees that if Tenant shall have any issue ("Service Requirement") related to, arising out of or connected with the condition of the apartment unit or the Premises or anything else under the Lease (each a "Unit Condition Matter"),  Tenant shall strictly follow the procedure outlined herein prior to filing a lawsuit or any other proceeding against Landlord or any of the Landlord Related Parties.  Unit Condition Matters shall include, without limitation, claims related to the habitability of the unit, defects in the unit, maintenance and repair related matters, bugs, roaches and similar creatures, etc. <br /><br />All initially capitalized terms
used in this Addendum without definition shall have the meaning ascribed to such terms in the Agreement to which this Addendum is attached.</p>
        <p><u>Procedure:</u></p>
        <table>
          <tr>
            <td width="15"></td>
            <td width="20">5.</td>
            <td width="500">Tenant shall notify Landlord in writing of such Service Requirement describing in detail the Unit Condition Matter, and shall provide Landlord a reasonable opportunity to cure the Unit Condition Matter;</td>
          </tr>
          <tr>
            <td></td>
            <td>6.</td>
            <td>If, within 10 days follows Landlord's receipt of the written Service Requirement, Tenant is not satisfied with the Landlord’s response or cure to the Unit Condition Matter, then Tenant shall notify Landlord in writing of such dissatisfaction, and shall provide Landlord a further reasonable opportunity, not to exceed 10 days unless additional time is reasonably necessary to effect the cure, to cure the Unit Condition Matter; </td>
          </tr>
          <tr>
            <td></td>
            <td>7.</td>
        ...
        <ol type="i">
            <li>the aggregate liability of Landlord and all Landlord Relates Parties to Tenant and all Occupants for all Unit Condition Matters shall not exceed $1,000 in the aggregate;</li>
            <li>such failure shall be a material breach of the Lease, which, among other remedies provided for in the Lease, shall entitle the Landlord to terminate the Lease on 30 days’ notice to the Tenant or such longer period as may be required by applicable law; and</li>
            <li>neither Tenant nor any Occupant shall be entitled to recover against any Landlord or any Landlord Related Parties or any other party (i) punitive damages, nor (ii) the fees, costs or other charges incurred by any attorney(s) representing Tenant, any Occupant or invitee of Tenant or Occupant in any such lawsuit or other legal proceeding, and Tenant hereby knowingly and intentionally waives any such rights to punitive damages and attorneys’ fees, whether by statute or otherwise.</li>
        </ol>
        ...
        <p><u>Liability Cap.</u> Notwithstanding anything else that may be construed to the contrary herein, aggregate liability of Landlord and all Landlord Relates Parties under the Lease for all Unit Condition Matters shall be capped at an amount equal to four (4) times the monthly rental rate payable by the Tenant each month up to a maximum aggregate amount of $10,000.  Tenant acknowledges that Landlord has set the monthly rental rate for the apartment unit based on the liability cap in the immediately preceding sentence, and that Landlord is relying on such liability cap in entering into the Agreement. Tenant further acknowledges and agrees that the liability cap hereunder is a reasonable cap taking into account the rent being charged under the Lease, the fact that the Lease is month-to-month, and that Tenant has an adequate remedy of terminating the Lease and moving to another apartment unit at a cost substantially less than the liability cap.  </p>
        <p>For the avoidance of doubt, each party shall bear its own attorney’s fees in any action or other proceeding related to, arising out of or connected with the Lease, including, without limitation, Unit Condition Matters. </p>
        <p><u>Written Notices:</u> All written notices to Landlord must be given to both the onsite manager of the apartment building with a copy being sent to the corporate headquarters of the management company and the Landlord at the following address: </p>
        <p>{!! $data['defaultValues']['notice_address_'][1] !!}</p>
        <p>(Phone number is) {!! $data['defaultValues']['payment_phone_number_'][2] !!} at (address)<br />{!! $data['defaultValues']['rent_payment_address_'][2] !!}</p>
        <p>Office hours: <u><b>9:00 AM</b></u> to <u><b>6:00 PM</b></u> on <u><b>Monday to Friday</b></u>. <u><b>10:00 AM</b></u> to <u><b>5:00 PM</b></u> on <u><b>Saturday</b></u> and </u><b>Sunday</b></u></p>
        <p>If there is no onsite manager, such written notice must instead be given to the local office of <br />{!! $data['defaultValues']['notice_local_address_'][1] !!} <br /> where tenant pays its rent, as well as to the corporate office.</p>
        <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
        <p>&nbsp;{!! $data['defaultValues']['tnt_signature_'][3] !!}{!! $data['defaultValues']['tenant_print_'][2] !!}</p>
        <h4 id="section_55_3"><b>55.3. Bed Bug Addendum</b></h4>
        ...
        <p>{!! $data['defaultValues']['full_prop_address_'][0] !!}</p>
        <p>Tenant and Landlord hereby enter into Bed Bug Addendum ("the Addendum") concurrently with and effective as of the date of the Agreement. This addendum sets forth the agreement of Tenant and Landlord for prevention of bed bugs at the Premises.</p>
        <ol style="padding-left:2.5%;">
            <li><b>Purpose:</b> This Addendum modifies the Agreement and addresses situations related to bed bugs, which may be discovered infesting the dwelling or personal property in the dwelling. You understand that we relied on your representations to us in this Addendum.</li>
            <li><b>Inspection:</b> You agree that you: (check one)<br>({!! $data['defaultValues']['inspection_done_'][0][0] !!}) have inspected the dwelling prior to move in and that you did not observe any evidence of bed bugs or bed bug infestation; or<br>({!! $data['defaultValues']['inspection_done_'][0][1] !!}) will inspect the dwelling within 24 hours after move-in/renewal and notify Landlord of any bed bugs or bed bug infestation.</li>
            <li><b>Infestations:</b> You agree that you have read the information in this addendum about bed bugs and: (check one)<br>({!! $data['defaultValues']['infestation_'][0][0] !!}) you are not aware of any infestation or presence of bed bugs in your current or previous dwellings or home. You agree that you are not aware of any bed bug infestation or presence in your furniture, clothing, personal property or possessions. You agree that you have not been subjected to conditions in which there was any bed bug infestation or presence, or<br>({!! $data['defaultValues']['infestation_'][0][1] !!}) you agree that if you previously lived anywhere that had a bed bug infestation that all of your personal property (including furniture, clothing and other belongings) has been treated by a licensed pest control professional. You agree that such items are free of further infestation. If you disclose a previous experience of bed bug infestation, we can review documentation of the treatment and inspect your personal property and possessions to confirm the absence of bed bugs. You agree that any previous bed bug infestation which you may have experienced is disclosed here:<br>{!! $data['defaultValues']['disclosed_infestations_'][0] !!}</li>
            <li><b>Access for Inspection and Pest Treatment:</b> You must allow us and our pest control agents to access the dwelling at reasonable times to inspect for or treat bed bugs as allowed by law. You and your family members, occupants, guests, and invitees must cooperate and will not interfere with inspections or treatments. We have the right to select any licensed pest control professional to treat the dwelling and building. We can select the method of treating the dwelling, building and common areas for bed bugs. You are responsible for and must, at your own expense, have your own personal property, furniture, clothing and possessions treated according to accepted treatment methods established by a licensed pest control firm that we approve. You must do so as close as possible to the time we treated the dwelling. If you fail to do so, you will be in default of the Agreement and we will have the right to terminate your right of occupancy and exercise all rights and remedies under the Agreement. You agree not to treat the dwelling for a bed bug infestation on your own.</li>
            <li><b>Notification:</b> You must promptly notify us: (i) of any known or suspected bed bug infestation or presence in the dwelling, or in any of your clothing, furniture or personal property, (ii) or if you discover any condition or evidence that might indicate the presence or infestation of bed bugs, or any confirmation of bed bug presence by a licensed pest control professional or other authoritative source.</li>
            <li><b>Cooperation:</b> If we confirm the presence or infestation of bed bugs, you must cooperate and coordinate with us and our pest control agents to treat and eliminate the bed bugs. You must follow all directions from us or our agents to clean and treat the dwelling and building that are infested. You must remove or destroy personal property that cannot be treated or cleaned as close as possible to the time we treated the dwelling. Any items you remove from the dwelling must be disposed of off-site and not in the property's trash receptacles. If we confirm the presence or infestation of bed bugs in your dwelling, we have the right to require you to temporarily vacate the dwelling and remove all furniture, clothing and personal belongings in order for us to perform pest control services. If you fail to cooperate with us, you will be in default, and we will have the right to terminate your right of occupancy and exercise all rights and remedies under the Agreement.</li>
            <li><b>Responsibilities:</b> You may be required to pay all reasonable costs of cleaning and pest control treatments incurred by us to treat your dwelling for bed bugs. If we confirm the presence or infestation of bed bugs after you vacate your dwelling, you may be responsible for the cost of cleaning and pest control treatments. If you fail to pay us for any costs you are liable for, you will be in default, and we will have the right to terminate your right of occupancy and exercise all rights and remedies under the Agreement.</li>
            <li><b>Transfers:</b> If we allow you to transfer to another property because of the presence of bed bugs, you must have your personal property and possessions treated according to accepted treatment methods or procedures established by a licensed pest control professional. You must provide proof of such cleaning and treatment to our satisfaction.</li>
        </ol>
        <h4><b>Bed Bug Information</b></h4>
        <table>
          <tr>
            <td style="padding-left:0;">
              <p class="left-padding-p">Bed bugs, with a typical lifespan of 6-12 months, are wingless, flat, broadly oval-shaped insects. Capable of reaching the size of an apple seed at full growth, bed bugs are distinguishable by their reddish-brown color, although after feeding on the blood of humans and warm-blooded animals -- their sole food source -- the bugs assume a distinctly blood-red hue until digestion is complete.<br><b>Bed Bugs Don't Discriminate</b><br>Bed bugs increased presence across the United States in recent decades can be attributed largely to a surge in international travel and trade. It's no surprise then that bed bugs have been found time and time again to have taken up residence in some of the fanciest hotels and apartment buildings in some of the nation's most expensive neighborhoods.<br>Nonetheless, false claims that associate bed bugs presence with poor hygiene and uncleanliness have caused rental housing Tenants, out of shame, to avoid notifying owners of their presence. This serves only to enable the spread of bed bugs.While bed bugs are, by their very nature, more attracted to clutter, they're certainly not discouraged by cleanliness.Bottom Line: bed bugs know no social and economic bounds; claims to the contrary are false.<br><b>Bed Bugs Don’t Transmit Disease</b><br>There exists no scientific evidence that bed bugs carry disease. In fact, federal agencies tasked with addressing pest of public health concern, namely the U.S. Environmental Protection Agency and the Centers for Disease Control and Prevention, have refused to elevate bed bugs to the threat level posed by disease carrying pests. Again, claims associating bed bugs with disease are false.<br><b>Identifying Bed Bugs</b><br>
          ...
          <table>
            <tr>
              <td width="500">
                <p class="left-padding-p"><b>Preventing Bed Bug Encounters When Traveling</b><br>
              Humans serve as bed bugs' main mode of transportation, it is extremely important to be mindful of bed bugs when away from home. Experts agree that the spread of bed bugs across all regions of the United States is largely attributed to an increase in international travel and trade. Travelers are therefore encouraged to take a few minutes upon arriving to their temporary destination to thoroughly inspect their accommodations, so as to ensure that any uninvited guests are detected before the decision is made to unpack. Bed bugs can easily travel from one room to another, it is also recommended that travelers thoroughly inspect their luggage and belongings for bed bugs before departing for home.<br>
              <b>Bed Bug Do’s & Don’ts</b></p>
                <ol type="a">
                  <li>Do not bring used furniture from unknown sources into your dwelling. Countless bed bug infestations have stemmed directly from the introduction into a Tenant's unit of second-hand and abandoned furniture. Unless the determination can be made with absolute certainty that a piece of second-hand furniture is bed bug-free, Tenants should assume that the reason a seemingly nice looking leather couch, for example, is sitting curbside, waiting to be hauled off to the landfill, may very well be due to the fact that it's teeming with bed bugs.</li>
                  <li>Do address bed bug sightings immediately. Tenants who suspect the presence of bed bugs in their property must immediately notify the Landlord. Do not attempt to treat bed bug infestations. Under no circumstances should you attempt to eradicate bed bugs. Health hazards associated with the misapplication of traditional and nontraditional, chemical based insecticides and pesticides poses too great a risk to you and your neighbors.</li>
                  <li>Do comply with eradication protocol. If the determination is made that your property is indeed playing host to bed bugs, you must comply with the bed bug eradication protocol set forth by both the Landlord and their designated pest management company.</li>
                </ol>
              </td>
            </tr>
          </table>
          <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p> {!! $data['defaultValues']['tnt_signature_'][4] !!}</p>
          <p>{!! $data['defaultValues']['tenant_print_'][3] !!}</p>
          <p><b>Landlord: {!! $data['defaultValues']['landlord_signature_'][2] !!}</b></p>
          <p><b>By:<br />{!! $data['defaultValues']['agent_signature_'][1] !!}</b></p>
          <h4 id="section_55_4"><b>55.4. Rental Mold and Ventilation Addendum</b></h4>
          <p>The following terms and conditions are hereby incorporated in and made a part of the Residential Lease or Month-to-Month Rental Agreement, on property located at: (<u>Property Address</u>, <u>Property Number</u>, <u>Unit Number</u>)</p>
          <p>{!! $data['defaultValues']['full_prop_address_'][1] !!}</p>
          ...
          <table>
            <tr>
              ...
              <td width="500">Maintain the Premises free of dirt, debris and moisture that can harbor mold;</td>
            </tr>
            <tr>
              <td></td>
              <td><b>2.</b></td>
              <td>Clean any mildew or mold that appears with an appropriate cleaner designed to kill mold;</td>
            </tr>
            <tr>
              <td></td>
              <td><b>3.</b></td>
              <td>Clean and dry any visible moisture on windows, walls and other surfaces, including personal property as quickly as possible;</td>
            </tr>
            <tr>
              <td></td>
              <td><b>4.</b></td>
              <td>Use reasonable care to close all windows and other openings in the Premises to prevent water from entering the Premises;</td>
            </tr>
            <tr>
              <td></td>
              <td><b>5.</b></td>
              <td>Use exhaust fans, if any, in the bathroom(s) and kitchen while using those facilities and notify Landlord of any inoperative exhaust fans;</td>
            </tr>
            <tr>
              <td></td>
              <td><b>6.</b></td>
              <td>Immediately notify Landlord of any water intrusion, including but not limited to, roof or plumbing leaks, drips or "sweating pipes";</td>
            </tr>
            <tr>
              <td></td>
              <td><b>7.</b></td>
              <td>Immediately notify Landlord of overflows from bathroom, kitchen or laundry facilities;</td>
            </tr>
            <tr>
              <td></td>
              <td><b>8.</b></td>
              <td>Immediately notify Landlord of any significant mold growth on surfaces in the Premises;</td>
            </tr>
            <tr>
              <td></td>
              <td><b>9.</b></td>
              <td>Allow Landlord, with appropriate notice, to enter the Premises to make inspections regarding mold and ventilation; and</td>
            </tr>
            <tr>
              <td></td>
              <td><b>10.</b></td>
              <td>Release, indemnify, hold harmless and forever discharge Landlord and Landlord's employees, agents, successors and assigns from any and all claims, liabilities or causes of action of any kind that Tenant, members of Tenant's household or Tenant's guests or invitees may have at any time against Landlord or Landlord's agents resulting from the presence of mold due to Tenant's failure to comply with this Lease/Rental Mold and Ventilation Addendum.</td>
            </tr>
          </table>
          <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p> {!! $data['defaultValues']['tnt_signature_'][5] !!}</p>
          <p>{!! $data['defaultValues']['tenant_print_'][4] !!}</p>
          <p><b>LANDLORD AGREES TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS</b></p>
          <p><b>Landlord: {!! $data['defaultValues']['landlord_signature_'][3] !!}</b></p>
          <p><b>By</b></p>
          <p><b></b>{!! $data['defaultValues']['agent_signature_'][2] !!}</p>
          <h4 id="section_55_5"><b>55.5. Addendum to Rental Agreement Apartment / House Rules</b></h4>
          <p>The following terms and conditions are hereby incorporated in and made a part of the Residential Lease or Month-to-Month Rental Agreement, on property located at: (<u>Property Address</u>, <u>Property Number</u>, <u>Unit Number</u>)</p>
          <p>{!! $data['defaultValues']['full_prop_address_'][2] !!}</p>
          ...
          <table class="addenda-table">
            <tr>
              <td width="15"></td>
              <td width="30"><b>A.</b></td>
              <td width="20"></td>
              <td width="450"><b>GENERAL</b></td>
            </tr>
            <tr>
              <td></td>
              <td><p></p></td>
              <td><p>1.</p></td>
              <td>This Addendum is incorporated by reference into the Rental Agreement between Landlord and Tenant.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>2.</td>
              <td>New rules and regulations or amendments to these rules may be adopted by Landlord upon giving 30 days’ notice in writing. These rules and any changes or amendments have a legitimate purpose and are not intended to be arbitrary or work as a substantial modification of tenant rights. They will not be unequally enforced. Tenant is responsible for their guests, and the adherence to these rules and regulations at all times, by all occupants or guests.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>3.</td>
              <td>In consideration of others, no Tenant shall make or emit any disturbing noises in the building by himself, his family or guests: nor do or permit anything by such persons that will interfere with the rights, comforts or convenience of other Tenants. Loud singing, playing on musical instruments or loud operation of a T.V., sound systems or recorder is not permitted. No loitering, visiting or loud talking is allowed outside the tenant's unit.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>4.</td>
              <td>In the event tenant or guest is inebriated; threatens, molests or disturbs another tenant or harasses manager; a three-day notice to quit will be served to tenant.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>5.</td>
              <td>Deposit and Rent Receipts: It is Tenant(s) responsibility to obtain receipt(s) for any payments made for the occupied premises. Tenants will not be discharged from their obligation without proof of payment.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>6.</td>
              <td>Tenant has inspected the premises, furnishings and equipment, and has found them to be satisfactory. All plumbing, heating and electrical systems are operative and deemed satisfactory .All deficiencies must be reported to Landlord in writing within 10 days from date of occupancy.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>7.</td>
              <td>All conduct in common area that unreasonably disturbs the quiet enjoyment of other tenants is prohibited.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>8.</td>
              <td>PETS AND WATER FILLED FURNITURE - Tenant agrees that he/she will not, without Landlord's expressed consent in writing endorsed hereon, bring upon, keep, maintain or permit to be kept or maintained, in, on, or upon the premises any dog, cat, bird, or other animal pet. Tenant agrees that he/she will not, without Landlord's expressed  consent In writing endorsed hereon, bring upon, keep, maintain or permit to be kept or maintained, in, on, or upon the premises any waterbeds, or liquid-filled furniture as provided under California <u>Civil Code</u> 1940.5</td>
            </tr>
            <tr>
              <td></td>
              <td><b>B.</b></td>
              <td></td>
              <td><b>NOISE AND CONDUCT</b></td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>1.</td>
              <td>Tenants shall not allow any disturbing noises in the unit by Tenant, family or guests, nor permit anything by such persons which will interfere with the rights, comforts or conveniences of other persons.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>2.</td>
              <td>Tenant(s) is responsible for the activities and conduct of Tenant and their quests, outside of the unit, on the common grounds, parking areas, or use of recreation facilities must be reasonable at all times and not annoy or disturb other persons.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>3.</td>
              <td>Alcoholic beverages may not be consumed by Tenants or their guests anywhere on the property other than inside a consenting Tenant's apartment.</td>
            </tr>
            <tr>
              <td></td>
              <td><b>C.</b></td>
              <td></td>
              <td><b>CLEANLINESS AND TRASH</b></td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>1.</td>
              <td>Landscaped portions of the property are intended to enhance the appearance of the property for all tenants. Tenants, occupants and guests are prohibited from any activity that threatens to or actually damages the landscaped features of the property including lawns, shrubs, flowerbeds or garden areas.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>2.</td>
              <td>Tenants shall assist Landlord in keeping the outside and common areas clean.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>3.</td>
              <td>Tenant shall not permit the littering of papers, cigarette butts or trash in and around the unit.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>4.</td>
              <td>Tenant shall ensure that no trash or other materials are accumulated which will cause a hazard or be in violation of any heath, fire or safety ordinance or regulation. The unit must be kept clean, sanitary and free from objectionable odors at all times.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>5.</td>
              <td>Tenant shall ensure that trash is placed inside the containers provided, and lids should not be slammed. Trash should not be allowed to accumulate and should be placed in the outside containers on a daily basis. Items too large to fit in the trash containers should be placed adjacent to the containers. Tenant shall not dispose of any combustible or hazardous material in the trash containers or bins. Such items will be deemed to be a nuisance and most be disposed of properly by the Tenant in accordance with State and local laws.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>6.</td>
              <td>All furniture must be kept inside the unit. Unsightly items must be kept out of sight.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>7.</td>
              <td>Tenant may not leave items in the hallways or other common areas.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>8.</td>
              <td>Clothing, curtains, rugs, etc., shall not be shaken or hung outside any window, ledge, or balcony.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>9.</td>
              <td>No car washing or car repairs are allowed at the property.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>10.</td>
              <td>Apartments with patios or balconies: Tenant must water and maintain shrubs and keep patios free of weeds. Landlord may inspect patios periodically. Neglect of the plants, shrubbery and trees will be considered damage to the premises. Barbecuing is permitted only on enclosed patios or the designated space where there are no patios. No outside storage is allowed in any patio or balcony. Common walk ways must always be kept clear.</td>
            </tr>
            <tr>
              <td></td>
              <td><b>D.</b></td>
            ...
            <tr>
              ...
              <td></td>
              <td>1.</td>
              <td>Security is the responsibility of each Tenant. Landlord assumes no responsibility or liability, unless otherwise provided by law, for Tenants' and guests' safety, or injury or damage caused by the acts of other persons. Landlord does not provide private protection services for Tenants.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>2.</td>
              <td>Tenant shall insure that all doors and windows are locked during Tenant's absence.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>3.</td>
              <td>Tenant shall insure that appliances be turned off before leaving the unit.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>4.</td>
              <td>When leaving for an extended period (over 14 days), Tenant shall notify Landlord how long Tenant will be away. Prior to any planned absence, Tenant shall give Landlord authority to enter the unit and provide Landlord with the name of any per­ son or entity permitted by Tenant to enter unit.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>5.</td>
              <td>Smoking in bed is prohibited.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>6.</td>
              <td>The use or storage of gasoline, cleaning solvent or other combustibles in the unit is prohibited.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>7.</td>
              <td>The use of charcoal barbecues is prohibited unless consent is obtained from the Landlord.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>8.</td>
              <td>Tenant shall insure that no personal belongings, including bicycles, play equipment or other items are left in the halls, balconies, and stairways or about the building unattended.</td>
            </tr>
            <tr>
              <td></td>
              <td><b>E.</b></td>
              <td></td>
              <td><b>MAINTENANCE, REPAIRS AND ALTERATIONS</b></td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>1.</td>
              <td>Tenant shall advise Landlord, in writing, of any items requiring repair (dripping faucets, light switches, etc.). Notification should be immediate in an emergency or for normal problems within business hours. Repair request should be made as soon as the defect is noted.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>2.</td>
              <td>All service requests be made to Resident Manager and/or Property Management Company in writing. No service request be made directly to maintenance person.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>3.</td>
              <td>No alterations or improvements shall be made by Tenant without the consent of Landlord. Any article attached to the woodwork, walls, floors or ceilings shall be the sole responsibility of the Tenant. Tenant shall be liable for any repairs necessary during or after residency to restore premises to the original condition. Glue or tape shall not be used to affix pictures or decorations.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>4.</td>
              <td>Costs to be paid by Tenant(s) due to their negligence: Tenant(s) will be charged for the costs incurred by the Landlord due to Tenant(s) carelessness and/or negligence. Some of the examples are broken windows, damaged screens, clogged drains, missing smoke detectors, scratches on the floors, bleach or oil spots on the carpet, missing light fixture covers, etc. Tenant(s) must pay upon demand. In the event Tenant(s) fail to pay, the Landlord and/or management may reduce the security deposit for that amount or file small claim action in court.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>5.</td>
              <td>Stoves & garbage disposals in working order are the Tenant's responsibility to maintain and keep clean.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>6.</td>
              <td>Nothing herein contained shall be construed to grant Tenant any right to enter upon any portion of the roof of said premises for any purpose whatsoever without Landlord's prior consent in writing. TENANT SHALL NOT ENTER INTO A CONTRACTUAL AGREEMENT   WITH A   CABLE T.V.  COMPANY OR SATELLITE DISH. If Tenant desires to have a satellite dish, a separate addendum must be executed.</td>
            </tr>
            <tr>
              <td></td>
              <td><b>F.</b></td>
              <td></td>
              <td><b>PARKING AND SPACES</b></td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>1.</td>
              <td>Inoperable, abandoned, unregistered vehicles or vehicles leaking fluids are subject to being towed pursuant to California Vehicle Code section 22658.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>2.</td>
              <td>All vehicles on the premises must be operational, currently registered and displaying current registration tags on the rear license plate, insured and free from leaking fluids. There shall be no vehicle repairs or maintenance performed on or about the premises.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>3.</td>
              <td>No Tenant shall keep, maintain or allow to remain on the premises for a period in excess of seven (7) days, any non- working, inoperable or non-functioning vehicle of any kind. The parties agree that the presence of any such vehicle on the premises for a period in excess of seven (7) days shall constitute a nuisance within the provisions of California <u>Civil Code</u>. Section 3479 and may, at Landlord's option, be the basis for terminating the tenancy herein.</td>
            </tr>
            <tr>
              <td></td>
              <td></td>
              <td>4.</td>
              <td>This notice affects all Tenants and their visitors. Licensed towing has been hired to enforce all parking regulations and to tow and impound any vehicles in violation that are parked on this property. Towing company will tow all vehicles that are: Parked in Driveways, Alleyways, Red Zones - Fire Lanes, Inoperative Vehicles, and Vehicles without Current Registration and Vehicles Backed into Carports. Use your assigned parking stall. If you do not have an assigned parking stall, see the manager. All visitors must park on the street. THERE WILL BE NO FURTHER NOTICES OR EXCEPTIONS AFTER THREE-DAY NOTICE IS GIVEN!! VIOLATORS WILL BE TOWED AWAY WITHOUT FURTHER WARNING. UNDER THE STATE LAW, VEHICLE(S) WITHOUT CURRENT REGISTRATION ARE CONSIDERED INOPERABLE.</td>
            </tr>
          </table>
          <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p><b>Tenant:</b></p>
          <p>{!! $data['defaultValues']['tnt_signature_'][6] !!}</p>
          <p>{!! $data['defaultValues']['tenant_print_'][5] !!}</p>
          <h4 id="section_55_6"><b>55.6. Move In / Move Out Inspection</b></h4>
          <p><b>Property Address</b> {!! $data['defaultValues']['prop_address_'][0] !!} <br />Unit No. {!! $data['defaultValues']['unit_no_'][1] !!}</p>
          <p>Inspection: Move In (Date) {!! $data['defaultValues']['move_in_date_'][0] !!} Move out (Date) {!! $data['defaultValues']['move_out_date_'][0] !!}</p>
          <p>Tenant(s): </p>
          <p>{!! $data['defaultValues']['tenant_lists_'][0] !!}</p>
...
<!--          <table class="simple-table">
            <tr>
              <td style="width:13%;"><b>N – NEW</b></td>
              <td style="width:34%;"><b>S – SATISFACTORY/CLEAN</b></td>
              <td style="width:19%;"><b>O – OTHER</b></td>
              <td style="width:34%;"><b>D – DEPOSIT DEDUCTION</b></td>
            </tr>
          </table>
          <table class="simple-table">
            <tr>
              <td style="width: 25%;"></td>
              <td style="width: 33%;"><b>MOVE IN</b></td>
              <td style="width: 42%;"><b>MOVE OUT</b></td>
            </tr>
          </table>-->
          <div class="row">
              <div class="col-sm-2"><h4>SECTION</h4></div>
              <div class="col-sm-5"><div class="row"><div class="col-sm-10 col-sm-offset-2"><h4>MOVE IN</h4></div></div></div>
              <div class="col-sm-5"><div class="row"><div class="col-sm-12 col-sm-offset-2"><h4>MOVE OUT</h4></div></div></div>
          </div>
          <div class="row">
              <div class="col-sm-2"></div>
              <div class="col-sm-5">
                  <div class="row">
                      <div class="col-sm-2"><label class="checkbox-inline"><b>N</b></label></div>
                      <div class="col-sm-2"><label class="checkbox-inline"><b>S</b></label></div>
                      <div class="col-sm-2"><label class="checkbox-inline"><b>O</b></label></div>
              ...
              <div class="col-sm-5">
                  <div class="row">
                      <div class="col-sm-2"><label class="checkbox-inline"><b>S</b></label></div>
                      <div class="col-sm-2"><label class="checkbox-inline"><b>O</b></label></div>
                      <div class="col-sm-2"><label class="checkbox-inline"><b>D</b></label></div>
                      <div class="col-sm-6"></div>
                  </div>
              </div>
          </div>
          ...
          <p><b>Other</b></p>
          {!! $data['defaultValues']['other_notes_'][0] !!}
          <h5><b>Move In Inspection</b></h5>
          <table class="table-form tnt-form" style="white-space:nowrap;">
            <tr>
                <td><p><b>Tenant’s Initial(s) &nbsp;&nbsp;&nbsp;</b>{!! $data['defaultValues']['tnt_initial_'][9] !!}</p></td>
            </tr>
            <tr>
              <td><p><b>Landlord’s/Authorized Agent’s Initials:</b></p></td>
            </tr>
            <tr>
              <td><p>{!! $data['defaultValues']['landlord_initial_'][1] !!}</p></td>
            </tr>
          </table>
          <h5><b>Move Out Inpsection</b></h5>
          <table class="table-form tnt-form" style="white-space:nowrap;">
            <tr>
                <td><p><b>Tenant’s Initial(s) &nbsp;&nbsp;&nbsp;</b>{!! $data['defaultValues']['tnt_initial_'][10] !!}</p></td>
            </tr>
            <tr>
              <td><p><b>Landlord’s/Authorized Agent’s Initials:</b></p></td>
            </tr>
            <tr>
              <td><p>{!! $data['defaultValues']['landlord_initial_'][2] !!}</p></td>
            </tr>
          </table>
          <h4 id="section_55_7"><b>55.7. Disclosure of Information on Lead-Based Paint and/or Lead-Based Paint Hazards</b></h4>
          <p>The following terms and conditions are hereby incorporated in and made a part of the Residential Lease or Month-to-Month Rental Agreement, on property located at: (<u>Property Address</u>, <u>Property Number</u>, <u>Unit Number</u>)</p>
          <p>{!! $data['defaultValues']['full_prop_address_'][3] !!}</p>
          ...
          <p><b>Lead Warning Statement</b><br>Housing built before 1978 may contain lead-based paint. Lead from paint, paint chips, and dust can pose health hazards if not managed properly. Lead exposure is especially harmful to young children and pregnant women. Before renting pre-1978 housing, Landlords must disclose the presence of known lead-based paint and/or lead-based paint hazards in the dwelling. Tenants must also receive a federally approved pamphlet on lead poisoning prevention.<br><b>Landlord’s Disclosure</b><br>
            Presence of lead-based paint and/or lead-based paint hazards (check (i) or (ii) below):<br>
            (i)  {!! $data['defaultValues']['lead_paint_knowledge_'][0][0] !!} Known lead-based paint and/or lead-based paint hazards are present in the housing (explain).<br>
            (ii) {!! $data['defaultValues']['lead_paint_knowledge_'][0][1] !!} Landlord has no knowledge of lead-based paint and/or lead-based paint hazards in the housing.<br>
            Records and reports available to the Landlord (check (i) or (ii) below):<br>
            (i)  {!! $data['defaultValues']['contains_paint_record_'][0][0] !!} Landlord has provided the Tenant with all available records and reports pertaining to lead-based paint and/or lead-based paint hazards in the housing (list documents below).<br>
            (ii) {!! $data['defaultValues']['contains_paint_record_'][0][1] !!} Landlord has no reports or records pertaining to lead-based paint and/or lead-based paint hazards in the housing.<br>
            <b>Tenant’s Acknowledgment (initial)</b><br>
            Tenant has received copies of all information listed above.<br>
            Tenant has received the pamphlet Protect Your Family from Lead in Your Home (attached to this addendum).
          </p>
          <table>
            <tr>
                <td style="white-space: nowrap;" width="500"><p><b>Tenant's Initial(s)&nbsp;&nbsp;&nbsp;</b>{!! $data['defaultValues']['tnt_initial_'][11] !!}</p>
            </tr>
          </table>
          <p><b>Certification of Accuracy</b><br>
            The Following parties have reviewed the information above and certify, to the best of their knowledge, that the information they have provided is true and accurate.
          </p>
          <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p><b>Tenant:</b></p>
          <p>{!! $data['defaultValues']['tnt_signature_'][7] !!}</p>
          <p>{!! $data['defaultValues']['tenant_print_'][6] !!}</p>
          <p><b>LANDLORD AGREES TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p><b>Landlord: {!! $data['defaultValues']['landlord_signature_'][5] !!}</b></p>
          <p><b>By:</b></p>
          <p><b></b>{!! $data['defaultValues']['agent_signature_'][4] !!}</p>
          <div class="disclosure-page">
            <div class="img-row">
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image1.jpg') }}">
              </div>
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image2.jpg') }}">
              </div>
            </div>
            <div class="img-row">
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image3.jpg') }}">
              </div>
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image4.jpg') }}">
              </div>
            </div>
          </div>
          ...
          <div class="disclosure-page">
            <div class="img-row">
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image5.jpg') }}">
              </div>
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image6.jpg') }}">
              </div>
            </div>
            <div class="img-row">
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image7.jpg') }}">
              </div>
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image8.jpg') }}">
              </div>
            </div>
          </div>
          <div class="disclosure-page">
            <div class="img-row">
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image9.jpg') }}">
              </div>
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image10.jpg') }}">
              </div>
            </div>
            <div class="img-row">
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image11.jpg') }}">
              </div>
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image12.jpg') }}">
              </div>
            </div>
          </div>
          ...
          <div class="disclosure-page">
            <div class="img-row">
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image13.jpg') }}">
              </div>
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image14.jpg') }}">
              </div>
            </div>
            <div class="img-row">
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image15.jpg') }}">
              </div>
              <div class="img-col">
                <img class="img-responsive" src="{{ URL::asset('/img/tenantRentalAgreement/image16.jpg') }}">
              </div>
            </div>
          </div>
          <h4 id="section_55_8"><b>55.8. Cleaning & Maintenance Guidelines</b></h4>
          <p><b>Dear Tenant,</b><br>
            It is our goal to provide a well maintained property at the beginning of the lease term and to work with you to maintain the property in good condition at all times during the Agreement. At the time you take possession of the property, it should be in a clean, well-maintained condition with all appliances and mechanical systems functioning correctly. Any pre-existing conditions and/or damages should be noted clearly on your <b><u>walk through inspection sheet</u></b>. If any conditions or damages are found that were not readily visible during the initial inspection they should be reported immediately.<br>
            The enclosed information outlines the PAMA Management policy regarding Tenant cleaning & maintenance responsibilities during the Agreement and, if followed, will help you receive a maximum security deposit refund at move out. This guide is intended as an outline of maintenance responsibility only and cannot address every possible cleaning or maintenance issue.
          </p>
          ...
          <p><b>Emergency maintenance items involving plumbing leaks where moisture is found in carpets walls or under sinks; function of the heating system, and hot water heater should be reported immediately to our office by phone.</b><br>
            Non-emergency maintenance items should be reported to our office in writing via email, postal service, or hand carried.<br>
            Please help us ensure that the property you reside in stays well maintained for your and the Landlord’s benefit for years to come by following the above procedures</p>
          <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p>{!! $data['defaultValues']['tnt_signature_'][8] !!}</p>
          <p>{!! $data['defaultValues']['tenant_print_'][7] !!}</p>
          <h4 id="section_55_9"><b>55.9 Notice of Periodic Application of Pesticides by Pest Control Operator Addendum</b></h4>
          <p>The following terms and conditions are hereby incorporated in and made a part of the Residential Lease or Month-to-Month Rental Agreement, on property located at: (<u>Property Address</u>, <u>Property Number</u>, <u>Unit Number</u>)</p>
          <p>{!! $data['defaultValues']['full_prop_address_'][4] !!}</p>
          ...
          <p>{!! $data['defaultValues']['tnt_signature_'][9] !!}</p>
          <p>{!! $data['defaultValues']['tenant_print_'][8] !!}</p>
          <h4 id="section_55_10"><b>55.10. Water Conservation Addendum</b></h4>
          <p>The following terms and conditions are hereby incorporated in and made a part of the Residential Lease or Month-to-Month Rental Agreement, on property located at: (<u>Property Address</u>, <u>Property Number</u>, <u>Unit Number</u>)</p>
          <p>{!! $data['defaultValues']['full_prop_address_'][5] !!}</p>
          ...
          <p>Links to local information and contacts is available at <a href="http://droughtresponse.acwa.com/agencies" target="_blank">http://droughtresponse.acwa.com/agencies</a></p>
          <ol>
          ...
          <p>{!! $data['defaultValues']['tnt_signature_'][9] !!}</p>
          <p>{!! $data['defaultValues']['tenant_print_'][8] !!}</p>
          <h4 id="section_55_11"><b>55.11 Water Sub-metering Addendum</b></h4>
          <table>
              <tr>
                <td width="10"></td>
                <td width="15"><b>1.</b></td>
                <td width="500"><p>The following terms and conditions are hereby incorporated in and made a part of the Residential Lease or Month-to-Month Rental Agreement, on property located at: (<u>Property Address</u>, <u>Property Number</u>, <u>Unit Number</u>)</p><p>{!! $data['defaultValues']['full_prop_address_'][5] !!}</p></td>
              </tr>
          </table>
          <h5><b><i>Water Sub-meter</i></b></h5>
          <p>The above-described premises are equipped with a water sub-meter. As required by California law, Resident will be billed for water service separately from the rent. The location of the sub-meter for this unit is {!! $data['defaultValues']['submeter_location_'][0] !!}</p>
          <h5><b><i>Estimated Water Bill</i></b></h5>
          <p>The estimated monthly bill for water service for dwelling units at the property is {!! $data['defaultValues']['submeter_cost_'][0] !!}. This estimate is based on (check one)<br />{!! $data['defaultValues']['bill_estimate_'][0][0] !!} The average / median bill for water service for comparative dwelling units at the property over any three of the past six months.</br />{!! $data['defaultValues']['bill_estimate_'][0][1] !!} The average indoor water use of a family of four, and all other monthly charges that will be assessed. The average family of four uses about 200 gallons of water each day.</p>
          <h5><b><i>Due Date and Payment  Procedures.</i></b></h5>
          <p>The water service bill is due on the <br />{!! $data['defaultValues']['water_service_bill_day_'][0] !!} day of each and every month, beginning on {!! $data['defaultValues']['submeter_date_'][0] !!}. The bill must be paid to the person specified, and using one of the payment methods (e.g., check, money order) required, for the payment of rent under the Rental/Lease Agreement.</p>
          ...
          <p>Name: {!! $data['defaultValues']['water_service_name_'][0] !!}<br />Mailing Address: {!! $data['defaultValues']['water_service_address_'][0] !!}<br />Email Address: {!! $data['defaultValues']['water_service_email_'][0] !!}<br />Toll-free or Local Telephone Number: {!! $data['defaultValues']['water_service_phone_'][0] !!}</p>
          <p>Regular telephone service at this number is available between the hours of {!! $data['defaultValues']['water_service_hour_from_'][0] !!} and {!! $data['defaultValues']['water_service_hour_to_'][0] !!} on the following days of the week:</p>
          <label class="checkbox-inline">{!! $data['defaultValues']['water_service_day_monday_'][0] !!} Monday</label>
          <label class="checkbox-inline">{!! $data['defaultValues']['water_service_day_tuesday_'][0] !!} Tuesday</label>
          <label class="checkbox-inline">{!! $data['defaultValues']['water_service_day_wednesday_'][0] !!} Wednesday</label>
          <label class="checkbox-inline">{!! $data['defaultValues']['water_service_day_thursday_'][0] !!} Thursday</label>
          <label class="checkbox-inline">{!! $data['defaultValues']['water_service_day_friday_'][0] !!} Friday</label>
          <label class="checkbox-inline">{!! $data['defaultValues']['water_service_day_saturday_'][0] !!} Saturday</label>
          <label class="checkbox-inline">{!! $data['defaultValues']['water_service_day_sunday_'][0] !!} Sunday</label><br />
          Other: {!!$data['defaultValues']['water_service_day_other_'][0] !!}
          ...
          <table>
              <tr>
                  ...
                  <td width="500"><h5><b>Allowable Charge</b></h5></td>
              </tr>
              <tr>
                  <td></td>
                  <td></td>
                  <td>
                      <p>The monthly bill for water service may only include the following charges:<ol type="a"><li>Payment due for the amount of usage as measured by the sub-meter and charged at allowable rates in accordance with Civil Code Section 1954.205(a).</li><li>Payment of a portion of the fixed fee charged by the water purveyors for water service.</li><li>A fee for the landlord’s or billing agent’s costs in accordance with Civil Code Section1954.205 (a) (3).</li><li>Any late fee, with the amounts and times assessed, in compliance with Civil Code Section 1954.213. A late fee of up to seven dollars ($7) may be imposed if any amount of a water service bill remains unpaid after 25 days following the date of mailing or other transmittal of the bill. If the 25th day falls on a Saturday, Sunday, or holiday, the late fee shall not be imposed until the day after the first business day following the 25th day. A late fee of up to ten dollars ($10) may be imposed in each subsequent bill if any amount remains unpaid.</li></ol></p>
                  </td>
              </tr>
          </table>
          ...
          <p>Name: {!! $data['defaultValues']['water_fixture_name_'][0] !!}<br />Mailiing Address: {!! $data['defaultValues']['water_fixture_address_'][0] !!}<br />Email Address: {!! $data['defaultValues']['water_fixture_email_'][0] !!}<br />Toll Free or Local Telephone Number: {!! $data['defaultValues']['water_fixture_phone_'][0] !!}</p>
          ...
          <p>Name: {!! $data['defaultValues']['submeter_name_'][0] !!}<br />Mailing Address: {!! $data['defaultValues']['submeter_address_'][0] !!}<br />Email Address: {!! $data['defaultValues']['submeter_email_'][0] !!}<br />Toll-free or Local Telephone Number: {!! $data['defaultValues']['submeter_phone_'][0] !!}</p>
          ...
          <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p>{!! $data['defaultValues']['tnt_signature_'][10] !!}</p>
          <p>{!! $data['defaultValues']['tenant_print_'][9] !!}</p>
          <h4 id="section_55_12"><b>55.12 Renter Insurance Addendum</b></h4>
          ...
          <ol>
              <li>Coverage of at least $15,000 in personal liability (bodily injury and property damage) for EACH occurrence;</li>
              <li>The premises listed above must be listed as the insured location and resident;</li>
              <li>Landlord is listed as a Certificated Holder;</li>
              <li>Notification that the Carrier must provide 30 days' notice of cancellation, non-renewal, or material change in coverage, to the Owner/Agent.</li>
          </ol>
          <p><b><u>Insurance Facts for Residents</u></b></p>
          <ol>
              <li>Generally, except under special circumstances, the OWNER IS NOT legally responsible for loss to the Resident's personal property, possessions or personal liability, and OWNER'S INSURANCE WILL NOT COVER such losses or damages.</li>
              <li>If damage or injury to OWNER'S PROPERTY is caused by resident(s), resident's guest(s), the OWNER'S insurance company may have right to attempt to recover from the Resident(s) payments made under the Owner's policy.</li>
              <li>If you the tenant(s) desire to protect yourself and your property against loss, damage, and/or liability, the Owner /strongly recommends you consult with your insurance agent and obtain appropriate coverage for fire, theft, liability, workers' compensation and other perils.</li>
          </ol>
          ...
          <p>{!! $data['defaultValues']['tnt_signature_'][10] !!}</p>
          <p>{!! $data['defaultValues']['tenant_print_'][9] !!}</p>
          <h4 id="section_55_13"><b>55.13 Satellite Dish and Antenna Addendum</b></h4>
          <p>The following terms and conditions are hereby incorporated in and made a part of the Residential Lease or Month-to-Month Rental Agreement, on property located at: (<u>Property Address</u>, <u>Property Number</u>, <u>Unit Number</u>)</p>
          <p>{!! $data['defaultValues']['full_prop_address_'][6] !!}</p>
          ...
          <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p>{!! $data['defaultValues']['tnt_signature_'][11] !!}{!! $data['defaultValues']['tenant_print_'][10] !!}</p>
          <h4 id="section_55_14"><b>55.14 Crime Free Lease Addendum</b></h4>
          <p>In consideration of the execution or renewal of a lease for the Identified property in the lease agreement, the OWNER and RESIDENT(S) agree as follows:</p>
          <ol>
          ...
          <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p>{!! $data['defaultValues']['tnt_signature_'][11] !!}{!! $data['defaultValues']['tenant_print_'][10] !!}</p>
          <h4 id="section_55_15"><b>55.15 No-Nuisance Lease Addendum</b></h4>
          ...
          <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
          <p>{!! $data['defaultValues']['tnt_signature_'][12] !!}{!! $data['defaultValues']['tenant_print_'][11] !!}</p>
          <h4 id="section_55_16"><b>55.16. Yard & Landscape Maintenance Addendum (If Applicable)</b></h4>
    <p>The following terms and conditions are hereby incorporated in and made a part of the Residential Lease or Month-to-Month Rental Agreement, on property located at: (<u>Property Address</u>, <u>Property Number</u>, <u>Unit Number</u>)</p>
    <p>{!! $data['defaultValues']['full_prop_address_'][7] !!}</p>
    
    <p>Tenant and Landlord hereby enter into this Yard & Landscape Maintenance Addendum ("the Addendum") concurrently with and effective as of the date of the Agreement.<br>
    ...
    <table>
        <tr>
            ...
            <td class="full-cell">
                <ol start="2">
                    <li><b>Lawn Watering:</b> Tenant must sufficiently water all lawn and grass areas ("Lawn") as needed to keep the Lawn green. To minimize evaporation and promote deeper saturation, the recommended watering time is early in the morning (4-8 AM). During the spring and summer the recommended watering frequency for is 4-5 days per week for 8 minutes. Depending on rainfall, during the fall and winter the frequency of watering can be reduced to 1-2 days per week for 8 minutes.</li>
                    <li><b>Lawn Maintenance:</b>Tenant must perform all mowing and edging. The Lawn should be mowed weekly during the spring and summer and every other week in the fall and winter. Tenant should edge around the driveway, sidewalks and planter areas at the same time the Lawn is mowed.  All debris and grass clippings must be blown off or swept clean from the driveway and surrounding yard and placed in the trash or a green recycling/compost bin.</li>
                    <li><b>Plant Watering and Maintenance: </b>Tenant must sufficiently water all planted areas ("Plants") as needed to keep plants green and growing and remove weeds. To minimize evaporation and promote deeper saturation, the best watering time is early morning (4-8 AM). The recommended watering frequency is 4-5 days per week for 10 minutes. In fall and winter the frequency can be reduced to 1-2 days per week for 8 minutes.</li>
                    <li><b>Irrigation Systems: </b>Tenant’s Premises may be equipped with an automatic sprinkler system and timer. If the system contains a timer, it should already be set to water at the appropriate time and frequency. Please be aware of warning signs that your sprinkler system might need adjustment. Inspect the lawn and plants bi-weekly for mold or excessive yellow coloration. These can be signs that the system is incorrect or malfunctioning.</li>
                    <li><b>Basic Maintenance: </b>Tenant should check the irrigation system regularly to ensure that it is working properly. Tenant must replace any damaged or broken sprinkler heads, mini sprayers, or drip lines and/or accessories with parts of "like kind". All replacement parts are readily available at your local Home Depot or equivalent hardware store.</li>
                    <li><b>Shrubs & Hedges: </b>Tenant must trim or prune all shrubs and hedges as needed and necessary to prevent excessive or unkempt growth. In the event the Premises is at the corner of intersecting streets, Tenant must keep all hedges or shrubs trimmed to a height that does not obstruct or obscure traffic visibility across the Premises.   Barring any local law or ordinance to the contrary, the height of shrubs and hedges in the front yard of a corner lot should not exceed two and one half feet.</li>
                    <li><b>Optional outside Landscaping Services: </b>Tenant may wish and is permitted to hire a landscape service company to do some or all of the yard and landscape maintenance for Tenant.</li>
                    <li><b>Back Yards: </b>Tenant is permitted to landscape back yard at their discretion. They must submit plans in writing to Landlord and Landlord must approve before work can commence.</li>
                    <li><b>Periodic Inspections: </b>Landlord will conduct twice-yearly exterior inspections of the Landscape Maintenance. Tenants whose Landscape Maintenance is not consistent with the guidelines set forth in this Addendum may be in default of the Rental Agreement.</li>
                </ol>
            </td>
        </tr>
    </table>
    <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
    <p>{!! $data['defaultValues']['tnt_signature_'][13] !!}{!! $data['defaultValues']['tenant_print_'][12] !!}</p>
    <h4 id="section_55_17"><b>55.17. Pool, Hot Tub, and Spa Addendum (If Applicable)</b></h4>
    <p>The following terms and conditions are hereby incorporated in and made a part of the Residential Lease or Month-to-Month Rental Agreement, on property located at: (<u>Property Address</u>, <u>Property Number</u>, <u>Unit Number</u>)</p>
    <p>{!! $data['defaultValues']['full_prop_address_'][5] !!}</p>
    ...
    <table>
        <tr>
            <td width="10"></td>
            <td width="10">1.</td>
            <td width="500">Swimming pools, hot tubs, and spas, while providing exercise, recreation, and relaxation, also can be dangerous. People (as well as pets) can be severely injured or drown if the pool, hot tub or spa is not properly used. Tenants are strongly cautioned that they, other occupants and tenant's guest must adhere to the following safe practices:<br />
                <ol type="a">
                    <li>No diving into the pool or hot tub or spa</li>
                    <li>No intoxicated persons may use the pool or hot tub or spa</li>
                    <li>No one should use the pool or hot tub or spa alone</li>
                    <li>All persons must have adequate swimming ability to use the pool / spa or be accompanied by a person with adequate swimming ability.</li>
                    <b><li>Tenant shall be responsible for making sure the self-latching gate into the pool area is fully functional at all times, that it is closed and latched at all time.</li></b>
                </ol>
            </td>
        </tr>
        <tr>
    ...
    <table>
        <tr>
            <td></td>
            <td>2.</td>
            <td>If the rental is part of a rental complex, the following also apply:<br />
                <ol type="a">
                    <li>The pool, hot tub or spa may only be used during posted hours.</li>
                    <li>All drinks must be served in unbreakable containers.</li>
                    <li>No alcoholic drinks are allowed in the pool area, hot tub or spa.</li>
                    <li>No excessive noise - please be considerate of your neighbors.</li>
                    <li>Users must shower prior to using the pool, hot tub or spa.</li>
                    <li>Use the pool safety equipment only in case of emergency.</li>
                    <li>HOA or House Rules, if applicable, will supplement or supersede these rules.</li>
                </ol>
            </td>
        </tr>
        <tr>
            <td></td>
            <td>3.</td>
            <td>NO LIFEGUARD WILL BE ON DUTY - YOU SWIM AT YOUR OWN RISK</td>
        </tr>
        <tr>
            <td></td>
            <td>4.</td>
...
<!--    <p>Tenant and Landlord hereby enter into Pool Maintenance & Equipment Addendum ("the Addendum") concurrently with and effective as of the date of the Agreement.</p>
    <p>Tenant hereby agrees and acknowledges that he/she will maintain the pool and related equipment located at the Premises during the Agreement term (collectively, "Pool Maintenance"). The Pool Maintenance shall be performed by Tenant in strict conformance with and pursuant to the following standards:</p>
    <table>
        <tr>
            <td class="full-cell">
                <ol>
                    <li><p class="scaled-p">Tenant agrees to enter into a pool maintenance contract with Landlord’s established vendor. Vendor will service the pool once a week for the duration of Agreement Term. <b>Tenant is not permitted to establish a pool service schedule outside of the established once per week schedule.</b></p></li>
                    <li><p class="scaled-p">Tenant will submit directly to Landlord.</p></li>
                    <li>
                        <p class="scaled-p">Tenant is responsible for pool maintenance and supplies. Landlord is responsible for mechanical equipment and filters.</p>
                        <ol type="a">
                            <li><p>Pool maintenance vendor: Phone: {!! $data['defaultValues']['pool_vendor_phone_'][0] !!}</p></li>
                            <li><p>{!! $data['defaultValues']['tenant_email_'][1] !!}</p></li>
                            <li><p>Monthly pool maintenance cost {!! $data['defaultValues']['pool_cost_'][0] !!}</p></li>
                            <li><p>Or paid directly to {!! $data['defaultValues']['pool_pay_to_'][0] !!}</p></li>
                    </li>
                </ol>
            </td>
        </tr>
    ...
    <p><b>THE UNDERSIGNED TENANT(S) ACKNOWLEDGES HAVING READ AND UNDERSTOOD THE FOREGOING, AND RECEIPT OF A DUPLICATE ORIGINAL. TENANT(S) AGREE TO RENT THE PREMISES ON THE ABOVE TERMS AND CONDITIONS.</b></p>
    <p> {!! $data['defaultValues']['tnt_signature_'][14] !!}{!! $data['defaultValues']['tenant_print_'][13] !!}</p>
    </form>
