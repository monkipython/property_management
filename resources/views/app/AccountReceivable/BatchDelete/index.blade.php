@extends('template', ['jsCss'=>'/AccountReceivable/batchDelete/batchDelete', 'data'=>$data])
...
<div class="col-md-3"><i class="fa fa-fw fa-credit-card"></i> Delete Batch <div class="arrow-container"><span id="arrow-btn" class="fa fa-fw fa-chevron-circle-left"></span></div></div>
@stop
        ...
        <div class="box-body no-padding gridTable" style="overflow-y: auto;">
          ...
          <div class="table-responsive mailbox-messages" id="sideMsgContainer" >
            ...
            <h2 class="text-center text-muted">
              ...
              Batch Delete function allows users to delete transactions that are not correctly recorded. When users use this feature to delete transaction, those deleted transaction cannot be restored back. <br><br><br> 
