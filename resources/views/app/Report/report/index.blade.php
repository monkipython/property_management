@extends('template', ['jsCss'=>'/report/report', 'data'=>$data])
...
@section('content-header')
  <div class="col-md-3"><i class="fa fa-fw fa-home"></i> All Reports <div class="arrow-container"><span id="arrow-btn" class="fa fa-fw fa-chevron-circle-left"></span></div></div>
@stop
