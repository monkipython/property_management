<form class="form-horizontal" id="businessLicensePaymentStoreForm"  autocomplete="off"> 
  <div class="row"> 
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <div class="box-header with-border">
                <h3 class="box-title"><span class="fa fa-fw fa-money"></span> Edit Business License Payment</h3>
              </div>
                {!! $data['form'] !!}
            </div>
          </div>
