<form class="form-horizontal" id="utilPaymentStoreForm"  autocomplete="off"> 
  <div class="row"> 
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <div class="box-header with-border">
                <h3 class="box-title"><span class="fa fa-fw fa-money"></span> Edit Utility Vendor Payment</h3>
              </div>
                {!! $data['form'] !!}
            </div>
          </div>
